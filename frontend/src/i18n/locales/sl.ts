const sl = {
  ...
  spotModal: {
    ...
    bannerOccupiedOwner: 'To mesto trenutno ni na voljo.',
    ...
    spotUnavailableOwnerMarked:
      'Mesto ni na voljo — označeno s strani lastnika',
    manageSpot: 'Upravljanje mesta',
    statusSection: 'Status',
    ownerControlledHint:
      'To mesto upravlja lastnik — samo lastnik lahko spremeni razpoložljivost.',
  ...
  admin: {
    ...
    ownerControlledStatusHint:
      'Upravlja lastnik — razpoložljivost ureja lastnik.',
    spotTypeLabel: 'Vrsta',
  ...
  ownerParking: {
    ...
    until: 'Do:',
    freeSpot: 'Označi mesto kot prosto',
    occupySpot: 'Označi mesto kot zasedeno',
    cancelReservation: 'Prekliči rezervacijo',
    ...
    unknown: 'Neznano',
    override: 'Sprememba',
    overrideIndefinite: 'Sprememba — do preklica',
    durationLabel: 'Za koliko časa?',
    durationDay: 'Samo izbrani dan',
    durationWeek: 'Naslednjih 7 dni',
    durationMonth: 'Naslednjih 30 dni',
    durationIndefinite: 'Do preklica',
    toggleHistoryOpen: 'Zapri zgodovino',
    toggleHistoryClosed: 'Prikaži zgodovino',
    statusActive: 'Aktivno',
    statusCancelled: 'Preklicano',
    statusExpired: 'Poteklo',
    toastSpotOccupied: 'Mesto {{label}} označeno kot zasedeno za {{date}}',
    toastSpotFreed: 'Mesto {{label}} označeno kot prosto za {{date}}',
    toastSpotOccupiedDays:
      'Mesto {{label}} označeno kot zasedeno za naslednjih {{days}} dni',
    toastSpotFreedDays:
      'Mesto {{label}} označeno kot prosto za naslednjih {{days}} dni',
    toastSpotOccupiedIndefinite:
      'Mesto {{label}} označeno kot zasedeno do preklica',
    toastSpotFreedIndefinite: 'Mesto {{label}} označeno kot prosto do preklica',
