const sl = {
  ...
  ownerParking: {
    ...
    toastSpotOccupiedDays:
      'Mesto {{label}} zasedeno za naslednjih {{days}} dni',
    toastSpotFreedDays: 'Mesto {{label}} sproščeno za naslednjih {{days}} dni',
    toastSpotOccupiedIndefinite: 'Mesto {{label}} zasedeno do preklica',
    toastSpotFreedIndefinite: 'Mesto {{label}} sproščeno do preklica',
