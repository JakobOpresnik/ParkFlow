const en = {
  ...
  ownerParking: {
    ...
    statusCancelled: 'Cancelled',
    statusExpired: 'Expired',
    toastSpotOccupied: 'Spot {{label}} occupied for {{date}}',
    toastSpotFreed: 'Spot {{label}} freed for {{date}}',
    toastSpotOccupiedDays: 'Spot {{label}} occupied for the next {{days}} days',
    toastSpotFreedDays: 'Spot {{label}} freed for the next {{days}} days',
    toastSpotOccupiedIndefinite: 'Spot {{label}} occupied until you change it',
    toastSpotFreedIndefinite: 'Spot {{label}} freed until you change it',
