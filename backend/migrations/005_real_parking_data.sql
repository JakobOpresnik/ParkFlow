...
INSERT INTO owners (id, name) VALUES
  ...
  ('b0000000-0000-0000-0000-000000000033', 'Nejc Frumen'),
...
-- Klet -1 (lot 2)
INSERT INTO spots (number, label, floor, status, owner_id, lot_id) VALUES
  (2,   'K1-2',  'Klet -1', 'occupied', 'b0000000-0000-0000-0000-000000000013', '10000000-0000-0000-0000-000000000002'),  -- Tesla S      (label→1VP54 in 015)
  (3,   'K1-3',  'Klet -1', 'occupied', 'b0000000-0000-0000-0000-000000000012', '10000000-0000-0000-0000-000000000002'),  -- Petra Jakovac (label→1VP53 in 015)
  (4,   'K1-4',  'Klet -1', 'occupied', 'b0000000-0000-0000-0000-000000000011', '10000000-0000-0000-0000-000000000002'),  -- Mitja Gornik  (label→1VP52 in 015)
  (5,   'K1-5',  'Klet -1', 'occupied', 'b0000000-0000-0000-0000-000000000010', '10000000-0000-0000-0000-000000000002'),  -- Urška Krivc   (label→1VP51 in 015)
  (6,   'K1-6',  'Klet -1', 'occupied', 'b0000000-0000-0000-0000-000000000014', '10000000-0000-0000-0000-000000000002'),  -- Tesla X       (renumbered→7, label→1VP55 in 015)
  (8,   'K1-8',  'Klet -1', 'occupied', 'b0000000-0000-0000-0000-000000000016', '10000000-0000-0000-0000-000000000002'),  -- oddano v najem: MIK
  (9,   'K1-9',  'Klet -1', 'occupied', 'b0000000-0000-0000-0000-000000000015', '10000000-0000-0000-0000-000000000002'),  -- Borut Mrak
  (10,  'K1-10', 'Klet -1', 'occupied', 'b0000000-0000-0000-0000-000000000017', '10000000-0000-0000-0000-000000000002'),
  (11,  'K1-11', 'Klet -1', 'occupied', 'b0000000-0000-0000-0000-000000000033', '10000000-0000-0000-0000-000000000002'),  -- Nejc Frumen
  ...
  (28,  'K1-28', 'Klet -1', 'occupied', 'b0000000-0000-0000-0000-000000000025', '10000000-0000-0000-0000-000000000002'),  -- Barbara Kepic
...
INSERT INTO spots (number, label, floor, status, owner_id, lot_id) VALUES
  ...
  (101, 'K2-101','Klet -2', 'free',     NULL,                                   '10000000-0000-0000-0000-000000000003')
ON CONFLICT (number, lot_id) DO UPDATE SET
  label    = EXCLUDED.label,
  floor    = EXCLUDED.floor,
  status   = EXCLUDED.status,
